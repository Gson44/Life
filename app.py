    ...
    if user_id:
        ...
        if user_data:
            ...
            if user_data[4] == 0:
                ...
                return render_template('dashboard.html', user_data=user_data[1], habit_data = habit_data, data=habit_data_json, status=user_data[4], predict=result)
    return redirect(url_for("home"))
...
def create_habit():
    if request.method == "POST":
        ...
        try:
            ...
            print("data inserted for habits")
            mysql.connection.commit()
